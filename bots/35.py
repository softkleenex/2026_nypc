...
MAP_PROFILES: dict[str, dict] = {
    "d2a733df6bdd": dict(hq_rush=True, hq_rush_turn=60),                 # 맵4
    "3940cf2df4a3": dict(parity=True, hq_rush=True, hq_rush_turn=140),   # 맵5
    "d4af0b974adc": dict(parity=True),                                   # 맵6
    "66d90b97143f": dict(war_econ=True, hq_cap=2),                       # 맵7
    "7453f3b06c85": dict(hq_rush=True, hq_rush_turn=60),                 # 맵8
}
