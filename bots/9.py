...
def decide(S: GameState, M: GameMap, P: Paths, turn: int) -> Actions:
    ...
    late_hq_upgrade_needed = stale_hq3 or tech_catchup_hq4 or tech_catchup_hq5 or adaptive_hq3 or adaptive_hq4
    late_hq_next_cost = (
        hq.upgrade_cost()
