...
DATA_FORMAT = "nypc-156-intent-json"
_DATA_CACHE = None
_DATA_LOADED = False
...
class Bot:
    ...
    def read_init(self) -> None:
        ...
        self.intent_hot_edges = self.load_intent_edges()
    ...
    def load_intent_edges(self) -> set[tuple[int, int]]:
        data = self.load_data()
    ...
    def plan(self) -> list[str]:
        ...
        if delayed_mass_alert:
            rush_alert = True
        intent_pressure_min = 3 if self.intent_hot_edges else 4
        intent_threat_min = 4 if self.intent_hot_edges else 5
        ...
        for _ in range(n):
            ...
            if s is not None:
                ...
                if wid[0] == self.foe and prev_r != r:
                    ...
                    edge_hot = (prev_r, r) in self.intent_hot_edges
