...
class Bot:
    ...
    def plan(self) -> list[str]:
        ...
        hq_score_behind = (
            hq_race and hq is not None and their_hq_b is not None
            and self.turn >= 150 and their_hq_b[2] > hq[2]
        )
        ...
        if hq_score_behind and n_bases >= 3:
            expandable = False  # 턴제한 HP 레이스 중 추가 확장이 HQ 캐치업을 먹지 않게 한다.
        ...
        if saving_for == 0 and not hq_upgrade_blocked and not hq_score_behind:
