...
class Bot:
    ...
    def plan(self) -> list[str]:
        ...
        if hq_score_catchup and n_bases >= 3:
            expandable = False  # desperate 카운터 중이어도 턴제한 HQ HP 캐치업을 먼저 한다.
        ...
        if saving_for == 0 and not hq_upgrade_blocked and not hq_score_catchup:
