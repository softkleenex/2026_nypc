...
class Bot:
    ...
    def plan(self) -> list[str]:
        ...
        desperate = (getattr(self, "unknown_map", False)
        ...
        allin_alert = (getattr(self, "unknown_map", False)
                       and self.turn <= 14
                       and (len(self.enemy) >= 5 and self.turn <= 8
        ...
        if (defend_at is None and getattr(self, "unknown_map", False)
                and not threatened and not self.attacking
