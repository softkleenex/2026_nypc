...
class Bot:
    ...
    def plan(self) -> list[str]:
        ...
        # 만렙(3) 기지는 더 올릴 수 없고, 손상돼도 이 루프가 건너뛰기만 해서
        # 지금까지 절대 수리되지 않았다 (BASE_REPAIR_COST가 정의만 되고 어디서도
        # 쓰이지 않는 죽은 상수였던 게 그 증거). 규칙상 레벨3 구역에 UPGRADE를
        # 내면 500골드 수리로 만피 회복이다 -- 공짜로 버려지던 경제/포탑을 구제.
        if saving_for == 0:
