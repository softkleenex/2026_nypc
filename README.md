...
xychart-beta
    ...
    x-axis ["#14 pre43", "#15 43", "#17 46", "#18 46", "#19 47", "#20 47", "#21 47", "#22 47", "#23 50", "#24 55", "#25 62", "#26 77", "#27 91", "#28 91", "#29 145", "#30 183"]
    y-axis "rating" 0 --> 2500
    line [1750, 1780, 1990, 1910, 1820, 1820, 1770, 1770, 1950, 1890, 1980, 1910, 1950, 1880, 1920, 1710]
```

```mermaid
xychart-beta
    title "User Evaluation Top Percentile (Lower Is Better)"
    x-axis ["#14 pre43", "#15 43", "#17 46", "#18 46", "#19 47", "#20 47", "#21 47", "#22 47", "#23 50", "#24 55", "#25 62", "#26 77", "#27 91", "#28 91", "#29 145", "#30 183"]
    y-axis "top %" 0 --> 70
    line [35.6, 25.2, 35.3, 49.5, 48.7, 43.5, 47.3, 47.9, 24.2, 31.9, 30.4, 29.2, 47.3, 39.9, 51.3, 61.8]
```
...
xychart-beta
    ...
    line [10.5, 11.0, 10.5, 10.0, 10.0, 10.0, 10.0, 10.0, 11.5, 11.0, 11.0, 11.0, 10.0, 10.5, 9.5, 9.0]
```
...
xychart-beta
    ...
    x-axis ["#14 pre43", "#15 43", "#17 46", "#18 46", "#19 47", "#20 47", "#21 47", "#22 47", "#23 50", "#24 55", "#25 62", "#26 77", "#27 91", "#28 91", "#29 145", "#30 183"]
    y-axis "wins" 0 --> 20
    bar [9, 11, 9, 6, 7, 9, 8, 7, 10, 9, 10, 10, 8, 9, 9, 8]
```
...
xychart-beta
    ...
    x-axis ["#14 pre43", "#15 43", "#17 46", "#18 46", "#19 47", "#20 47", "#21 47", "#22 47", "#23 50", "#24 55", "#25 62", "#26 77", "#27 91", "#28 91", "#29 145", "#30 183"]
    y-axis "losses" 0 --> 20
    bar [8, 9, 8, 6, 7, 9, 8, 7, 7, 7, 8, 8, 8, 8, 10, 10]
```

| Eval | Bot | User W-D-L | Score | Tier | Rating | Rank | Top % | Logs |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| #14 | pre43 | 9-3-8 | 10.5 | 7 | 1750 | 249 / 700 | 35.6% | 20 / 20 |
| #15 | 43 | 11-0-9 | 11.0 | 7 | 1780 | 181 / 718 | 25.2% | 20 / 20 |
| #17 | 46 | 9-3-8 | 10.5 | 9 | 1990 | 264 / 747 | 35.3% | 20 / 20 |
| #18 | 46 | 6-8-6 | 10.0 | 9 | 1910 | 377 / 762 | 49.5% | 20 / 20 |
| #19 | 47 | 7-6-7 | 10.0 | 7 | 1820 | 382 / 784 | 48.7% | 20 / 20 |
| #20 | 47 | 9-2-9 | 10.0 | 7 | 1820 | 344 / 790 | 43.5% | 20 / 20 |
| #21 | 47 | 8-4-8 | 10.0 | 7 | 1770 | 380 / 804 | 47.3% | 0 / 20 |
| #22 | 47 | 7-6-7 | 10.0 | 7 | 1770 | 396 / 826 | 47.9% | 20 / 20 |
| #23 | 50 | 10-3-7 | 11.5 | 9 | 1950 | 202 / 833 | 24.2% | 20 / 20 |
| #24 | 55 | 9-4-7 | 11.0 | 7 | 1890 | 270 / 846 | 31.9% | 20 / 20 |
| #25 | 62 | 10-2-8 | 11.0 | 9 | 1980 | 263 / 864 | 30.4% | 20 / 20 |
| #26 | 77 | 10-2-8 | 11.0 | 9 | 1910 | 256 / 876 | 29.2% | 20 / 20 |
| #27 | 91 | 8-4-8 | 10.0 | 9 | 1950 | 420 / 888 | 47.3% | 20 / 20 |
| #28 | 91 | 9-3-8 | 10.5 | 7 | 1880 | 362 / 907 | 39.9% | 20 / 20 |
| #29 | 145 | 9-1-10 | 9.5 | 9 | 1920 | 469 / 914 | 51.3% | 20 / 20 |
| #30 | 183 | 8-2-10 | 9.0 | 7 | 1710 | 579 / 937 | 61.8% | 20 / 20 |

`#14 pre43`은 정확한 대표 제출 파일 번호가 남지 않은 초기 평가입니다. `#16`은
보관된 자료가 없고, `#21`은 랭킹 요약만 남아 있어 match log 원문은 비어 있습니다.
...
- `bots/`: 제출 봇, 선택 `data.bin`, NYPC 공식 로그, 유저 평가 로그입니다. 유저 로그는 `eval##_bot<bot>_user_log/` 형식으로 정리합니다.
