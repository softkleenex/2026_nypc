...
xychart-beta
    ...
    x-axis ["#14 pre-43", "#25 62", "#26 77", "#28 91", "#29 145", "#30 183"]
...
xychart-beta
    ...
    x-axis ["#14 pre-43", "#25 62", "#26 77", "#28 91", "#29 145", "#30 183"]
    y-axis "top %" 0 --> 70
    line [35.6, 30.4, 29.2, 39.9, 51.3, 61.8]
```
...
| Eval | Bot | User W-D-L | Score | Tier | Rating | Rank | Top % |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| #14 | pre-43 | 9-3-8 | 10.5 | 7 | 1750 | 249 / 700 | 35.6% |
| #25 | 62 | 10-2-8 | 11.0 | 9 | 1980 | 263 / 864 | 30.4% |
| #26 | 77 | 10-2-8 | 11.0 | 9 | 1910 | 256 / 876 | 29.2% |
| #28 | 91 | 9-3-8 | 10.5 | 7 | 1880 | 362 / 907 | 39.9% |
| #29 | 145 | 9-1-10 | 9.5 | 9 | 1920 | 469 / 914 | 51.3% |
| #30 | 183 | 8-2-10 | 9.0 | 7 | 1710 | 579 / 937 | 61.8% |

`#14 pre-43`은 정확한 대표 제출 파일 번호가 남지 않은 초기 평가입니다. 작업 로그상
43에서 해당 평가의 초단기 all-in 대응을 추가했으므로, 43 이전 계열로 표기했습니다.
